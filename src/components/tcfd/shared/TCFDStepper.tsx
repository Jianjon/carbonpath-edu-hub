...
const TCFDStepper = ({ currentStep, steps }: TCFDStepperProps) => {
  return (
    <div className="flex items-center justify-center gap-6 sm:gap-12 mb-8 py-8 bg-gradient-to-r from-slate-50 to-blue-50">
        ...
        {steps.map((step, index) => {
          ...
          return (
            <div key={step.title} className="flex flex-col items-center text-center">
              {/* 圖標容器 */}
              <div className={`w-16 h-16 rounded-full flex items-center justify-center border-2 mb-3 transition-all duration-300 ${
                isActive 
