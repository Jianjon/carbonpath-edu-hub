...
import { BookOpen, SlidersHorizontal, Calculator, Scaling } from 'lucide-react';

const carbonTaxSteps: StepConfig[] = [
  { title: '參數與情境設定', icon: SlidersHorizontal },
  { title: '碳費計算', icon: Calculator },
  { title: '碳費VS減碳成本', icon: Scaling },
];
