...
const TCFDProcessFlow = () => {
  ...
  return <div className="rounded-lg p-8 shadow-sm border border-gray-200 mb-8 bg-slate-50">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center space-y-6 lg:space-y-0 lg:space-x-6">
        {steps.map((step, index) => <div key={step.id} className="flex flex-col lg:flex-row items-center">
            {/* 步驟圓圈 */}
            ...
            {/* 箭頭連接線 */}
            {index < steps.length - 1 && <div className="hidden lg:flex items-center mx-4">
                <ArrowRight className="w-5 h-5 text-gray-300" />
              </div>}
            
            {/* 手機版向下箭頭 */}
            {index < steps.length - 1 && <div className="lg:hidden mt-2">
