...
export const actionsData: ActionData = {
  ...
  '零售業': {
    '能源管理': [
      { id: 'ret-en-1', name: '更換為變頻節能空調', description: '汰換老舊定頻空調，依據人流與氣溫智慧調節。', investment: '高' },
      { id: 'ret-en-2', name: '導入智慧能源監控系統', description: '即時監控賣場各區域用電，找出異常能耗點。', investment: '中' },
    ],
    '循環經濟': [
      { id: 'ret-ci-1', name: '推動綠色包裝與回收', description: '採用簡化、可回收、或生質材料包裝，並設置回收站點。', investment: '中' },
    ],
    '永續採購': [
      { id: 'ret-su-1', name: '引進具環保標章商品', description: '提供消費者更多綠色選擇，提升企業永續形象。', investment: '低' },
    ],
    '淨零管理': [
       { id: 'ret-ne-1', name: '規劃員工節能SOP', description: '制定開關燈、空調、設備使用的標準作業流程。', investment: '低' },
    ],
  },
  '製造業': {
    '能源管理': [
